    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (operation === 'upload') {
                ...
                res = await axios.post('http://localhost:8080/communications/upload', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
                });
            } else if (operation === 'save') {
                res = await axios.post('http://localhost:8080/communications', dataToSend);
            } else if (operation === 'update') {
                res = await axios.put(`http://localhost:8080/communications/${id}`, dataToSend);
            } else if (operation === 'delete') {
                await axios.delete(`http://localhost:8080/communications/${id}`);
